...
if __name__ == "__main__":
    ...
    (DATASET, radius, ngram, dim, layer_gnn, window, layer_cnn, layer_output,
     ...
     setting) = ['dude', 2, 3, 10,3, 11, 3, 3, 1e-3, 0.5, 10, 1e-6,100,
     'dude--radius2--ngram3--dim10--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration100']
